$(document).ready(function(){  
	...
	function aggreShenhe() {
	    ...
	    $.ajax({
	        ...
	        url :"updateGood",
	        dataType :"json",
	        data:{"Goods.goodIdId":goodId},
	        success:function(){}
	    });
	    }
	function disAggreShenhe() {
  ...
  window.onload=function(){
   var boxBtn=document.getElementsByClassName("sub1111111");
 // var goodId=document.getElementByClassName("goodId"); 
  // alert(goodId.innerHTML);
